...
- [`docs/trust.md`](./docs/trust.md) — trust model vocabulary, manifest, bootstrap, and capability prep.
- [`docs/storage.md`](./docs/storage.md) — repository store boundary and backend evaluation criteria.
